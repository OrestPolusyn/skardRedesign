...
var _vendorJs = require("./js/_vendor.js");
var _functions = require("./js/_functions");
var _components = require("./js/_components");

},{"./js/_vendor.js":"b6bvw","./js/_functions":"8TNrF","./js/_components":"b1Ec9"}],"b6bvw":[function(require,module,exports) {
...
},{"./functions/_headerScrollHide":"7Umnm"}],"7Umnm":[function(require,module,exports) {
...
},{"../_config.js":"llBLd","./_toggleClassItem":"ekfZO"}],"llBLd":[function(require,module,exports) {
...
},{"../_config":"llBLd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b1Ec9":[function(require,module,exports) {
var _burger = require("./components/_burger");
var _sliders = require("./components/_sliders");
var _observeAnimation = require("./components/_observeAnimation");

},{"./components/_burger":"aATkn","./components/_sliders":"lxhZB","./components/_observeAnimation":"72KOe"}],"aATkn":[function(require,module,exports) {
...
},{}],"lxhZB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _swiper = require("swiper");
var _swiperDefault = parcelHelpers.interopDefault(_swiper);
const productSlider = new (0, _swiperDefault.default)(".mission__line", {
    modules: [
...
const dragLine = new (0, _swiperDefault.default)(".products__slider", {
    modules: [
...
},{"../../shared/create-shadow.js":"9JYAP","../../shared/effect-init.js":"5DnvG","../../shared/effect-target.js":"eKqS8","../../shared/effect-virtual-transition-end.js":"VhYFx","../../shared/utils.js":"dbikn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"72KOe":[function(require,module,exports) {
const observerTitle = new IntersectionObserver((entries)=>{
    entries.forEach((entry)=>{
        if (entry.intersectionRatio > 0) entry.target.classList.add("title-animation", entry.isIntersecting);
    });
});
...
const observerBtn = new IntersectionObserver((entries)=>{
    entries.forEach((entry)=>{
        if (entry.intersectionRatio > 0) entry.target.classList.add("btn-animation", entry.isIntersecting);
    });
});
document.querySelectorAll("button:not(.products__btn,.burger,.missions__list .btn), .btn:not(.header a, .missions__list .btn)").forEach((btn)=>{
    observerBtn.observe(btn);
});
const observerText = new IntersectionObserver((entries)=>{
    entries.forEach((entry)=>{
        if (entry.intersectionRatio > 0) entry.target.classList.add("text-animation", entry.isIntersecting);
    });
});
document.querySelectorAll("p, h3,.advantages__item").forEach((btn)=>{
    observerText.observe(btn);
});
const observerIcons = new IntersectionObserver((entries)=>{
    entries.forEach((entry)=>{
        if (entry.intersectionRatio > 0) entry.target.classList.add("icons-animation", entry.isIntersecting);
    });
});
document.querySelectorAll(".data__image").forEach((image)=>{
    observerIcons.observe(image);
});
const observerImage = new IntersectionObserver((entries)=>{
    entries.forEach((entry)=>{
        if (entry.intersectionRatio > 0) entry.target.classList.add("image-animation", entry.isIntersecting);
    });
});
document.querySelectorAll(".partners__link").forEach((image, index)=>{
    setInterval(()=>{
        observerImage.observe(image);
    }, 400 * index + 2);
});
document.querySelector(".missions__list .btn").addEventListener("click", (e)=>{
    e.target.closest(".missions__item").classList.add("tab");
});
